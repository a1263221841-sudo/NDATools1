...
private slots:
    void on_pushButton_TCPServerStartListen_clicked();
    void on_pushButton_TCPServerCloseListen_clicked();
    void on_pushButton_TCPServerQuit_clicked();
    void on_pushButton_TCPServerSendMsg_clicked();
private:
    Ui::FormTcpServer *ui;

    QTcpServer *tcpServer = nullptr ; //服务器监听实例
    QTcpSocket *tcpServerSocket =nullptr ; //最近一次建立的socket,用于简单模式
